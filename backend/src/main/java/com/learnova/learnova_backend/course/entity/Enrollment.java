...
@Table(name = "enrollments", uniqueConstraints = {
        @UniqueConstraint(name = "uk_learner_course", columnNames = { "learner_profile_id", "course_id" })
})
@Getter
@Setter
@NoArgsConstructor
...
public class Enrollment {
    ...
    @JoinColumn(name = "learner_profile_id", nullable = false, foreignKey = @ForeignKey(name = "fk_enrollments_learner_profile"))
