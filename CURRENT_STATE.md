...
- No live, successfully-completed real Cloudinary upload yet — the upload pipeline is verified up to the Cloudinary API call, which currently fails cleanly with a `502` due to placeholder credentials in dev; real Cloudinary credentials are still pending
