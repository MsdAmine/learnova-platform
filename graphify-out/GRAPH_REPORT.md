...
Cohesion: 0.10
Nodes (20): Body Text, Body Text Reference, Button Typography, Default Body, Design Rules, H1, H2, H3 (+12 more)
...
Cohesion: 0.09
Nodes (22): 0. Scope & Assumptions, 1. Layout & Structure, 2. Token Mapping, 3. Component Reusability, 4. Design-Rule Compliance Notes, Content-column wireframe (lg), Course card — Completed, Course card — In progress (+14 more)
...
Cohesion: 0.25
Nodes (7): Backend Status, Current Milestone, Current Priority, Current State, Frontend Status, Project Name, What Not to Do
