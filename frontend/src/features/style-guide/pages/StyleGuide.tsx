  ...
  return (
    <section className="flex flex-col gap-8">
      ...
      <Row label="With image src">
        <Avatar size={40} name="Photo User" src="https://i.pravatar.cc/80?img=12" />
        <Avatar size={56} name="Photo User" src="https://i.pravatar.cc/112?img=33" />
        <Avatar size={80} name="Photo User" src="https://i.pravatar.cc/160?img=47" />
      </Row>
