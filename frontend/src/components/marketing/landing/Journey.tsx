...
const steps = [
  {
    ...
    primaryCta: { label: 'Catalog', href: '/courses' },
    secondaryCta: { label: 'Browse catalog', href: '/courses' },
    image: {
      src: journey1Url,
  ...
  },
  {
    ...
    primaryCta: { label: 'Dashboard', href: '/dashboard' },
    secondaryCta: { label: 'Start learning', href: '/courses' },
    image: {
      src: journey2Url,
  ...
  },
  {
    ...
    primaryCta: { label: 'Certificates', href: '/certificates' },
    secondaryCta: { label: 'View certificates', href: '/certificates' },
    image: {
      src: journey3Url,
